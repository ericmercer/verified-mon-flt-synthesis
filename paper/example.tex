...
From time to time, SW receives a message on \texttt{AutomationRequest},
...
AGREE code-contract specifications are discussed in detail in \secref{sec:code-contracts}.
