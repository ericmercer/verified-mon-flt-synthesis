...
The motivation here was to showcase the toolchain on an industrial scale problem, to see if the technology works, i.e. provides engineers with early validation of their model; provides early information about cyber-vulnerabilities and in the effectiveness of related mitigations; to show that the tool can handle the UXAS message format (a complex, real-world message format); and to validate the utility and capability of the toolchain.
