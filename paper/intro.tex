...
and a means to show that the synthesis is correct. We see the
following as the contributions of this paper:
...
\begin{compactitem}
  ...
  \item A case study that uses \brfcs\ to add cyber-resiliency to a non-trivial UAV system.
\end{compactitem}
