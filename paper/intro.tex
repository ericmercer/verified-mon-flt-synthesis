\egm{Rewrite to make clear the contribution here: code contracts, tests, and synthesis through SPLAT. 
Present the \emph{unverified} path as is done in the introduction.
See if it is possible to present the verified path (ping Konrad) to state the various correctness guarantees.}
...
Another novel aspect of the approach is the synthesis of the \agr\ 
