...
Test contracts are a tool to help detecting vacuity, under-specification, and missed corner cases.
%
...
The data integrity requirements serve to prevent any malformed messages from causing a buffer overrun or code injection attack.
%
