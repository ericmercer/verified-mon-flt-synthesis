...
\SetWatermarkText{\raisebox{\textheight}{%
\begin{minipage}{\textwidth}%
\vspace{-18pt}\hfill%
\href{http://doi.org/10.5281/zenodo.5129276}{% REPLACE WITH YOUR ARTIFACT DOI
\includegraphics[width=0.6in, height=0.6in]{reusable}% IF REUSABLE BADGE GRANTED
\includegraphics[width=0.6in, height=0.6in]{available}% IF AVAILABLE BADGE GRANTED
}
\end{minipage}%
}}
...
\begin{document}
\title{
  Synthesizing Verified Components~~~\\
  for Cyber Assured Systems Engineering~
