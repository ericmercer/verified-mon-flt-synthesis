...
%
On the other hand, a filter may need to parse the input buffer into a data structure specified in \agr\ and apply a user-defined \emph{wellformedness} property, also specified in \agr, to the data.
%
