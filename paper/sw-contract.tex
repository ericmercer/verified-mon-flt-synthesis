...
\lineref{line:sw-guarantee-6} ensures that once alerted always alerted since an alert in the pre-state requires an alert in the post-state., \texttt{\textbf{Once}(alrt) \textbf{and} alrt}.
