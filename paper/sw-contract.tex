...
\item \lineref{line:sw-guarantee-5}. The alert to sounds if the start does not arrive within the one-step bound. Together with \lineref{line:sw-guarantee-4} this allows
