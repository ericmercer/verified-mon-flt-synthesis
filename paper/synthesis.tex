...
%% where the $\mathit{state}$ parameters to the function are just the
%% variables defined in ${\Eqs}$, obtained by projecting out the

%%  = \mathit{Env}\vert_{\mathbb{I}}$ $\mathit{input}
%%  = \mathit{Env}\vert_{\mathbb{I}}$ $\mathit{input}
%%  = \mathit{Env}\vert_{\mathbb{I}}$
